...
<main>
    ...
    <form class="register" action="action_register.php" method="POST">
        <input type="text" name="username" placeholder="username" pattern="^[A-Za-z][A-Za-z0-9_]{3,}$" title="Minimum 3 characters, start with an alphabet and all other characters can be alphabets, numbers or an underscore">
        ...
        <input type="checkbox" id="option1" name="restOwner" value="restOwner">
        <label for="option1">Restaurant Owner</label>
        <input type="checkbox" id="option2" name="costumer" value="costumer">
